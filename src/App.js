...
class App extends Component {
  ...
  getPotentialBuyers() {
    ...
    axios
      ...
      .then(res => {
        ...
        toast.success("Buyers loaded")
      })
      .catch(error => {
        toast.error("Couldn't load buyers")
      })
  }
  ...
  filterByColor() {
    ...
    axios
      ...
      .catch(err => toast.error("Could not filter by color"))
    // axios (GET)
    // setState with response -> vehiclesToDisplay
  }

  updatePrice(priceChange, id) {
    //axios (PUT) new path with parameters passed in
    axios
      .put(`https://joes-autos.herokuapp.com/api/vehicles/${id}/${priceChange}`)
      .then(res => {
        //setState to new vehicle data
        this.setState({
          vehiclesToDisplay: res.data.vehicles
        })
        //alert success
        toast.success("Price has changed!")
      })
      //alert error
      .catch(error => {
        toast.error("Error")
  ...
  addCar() {
    //this is generated using onChange events
    let newCar = {
    ...
    // axios (POST) using API url and second parameter of the object to be added
    axios
  ...
  addBuyer() {
    ...
    axios
      ...
      .catch(err => {
        toast.error("Could not add buyer")
      })
  }
  ...
  nameSearch() {
    ...
    axios
      ...
      .catch(err => toast.error("Could not filter by name"))
    // axios (GET)
    // setState with response -> buyersToDisplay
  }
  ...
  byYear() {
    ...
    axios
      ...
      .catch(err => toast.error("Could not filter by year!"))
    // axios (GET)
    // setState with response -> vehiclesToDisplay
  }
